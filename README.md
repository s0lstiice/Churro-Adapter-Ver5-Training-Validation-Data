# CHURRO LOC Layout-Robust Version 5: complete data lineage
...
promoted **CHURRO LOC Layout-Robust Version 5** adapter.
...
- Ver5: 2,500 full-page training rows and 250 full-page validation rows.
...
Later stages inherit earlier LoRA weights, so the Ver5 model reflects all
...
The same trusted page corpus was deliberately replayed across VerB and
VerC, and parts may reappear in the expanded Ver5 training corpus. That is
...
found six Ver5 validation images used in earlier training and four images
from the omission-45 benchmark used during Ver5 training. Consequently,
